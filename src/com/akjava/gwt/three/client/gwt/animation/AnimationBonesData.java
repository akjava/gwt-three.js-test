...
public class AnimationBonesData {
	private List<Matrix4> bonesMatrixs;
	private List<Vector3> baseBonePositions;
	public List<Matrix4> getBonesMatrixs() {
		return bonesMatrixs;
	}

	public void setBonesMatrixs(List<Matrix4> bonesMatrixs) {
	...
	public AnimationBonesData(JsArray<AnimationBone> bones,List<Matrix4> bonesMatrix){
	...
	public Vector3 getPosition(int index){
		...
		Matrix4 tmpmx=bonesMatrixs.get(path.get(path.size()-1));
		...
		//	log(""+path.get(j));
			Matrix4 mx=bonesMatrixs.get(path.get(j));
	...
	public void setBoneMatrix(int index,Matrix4 matrix){
